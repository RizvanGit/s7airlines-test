  ...
  <div>
    <div ref={ref} className='keen-slider max-w-screen-xl mx-auto'>
      <div className='keen-slider__slide number-slide1'>
        <Image src={PictureOne} alt='banner1' style={{width: '100%', height: 'auto'}}/>
      </div>
      <div className='keen-slider__slide number-slide2'>
        <Image src={PictureTwo}  alt='banner2' style={{width: '100%', height: 'auto'}}/>
      </div>
      <div className='keen-slider__slide number-slide2'>
        <Image src={PictureThree}  alt='banner3' style={{width: '100%', height: 'auto'}}/>
      </div>
    </div>
