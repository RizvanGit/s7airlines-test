...
const Search: FC = () => {
  ...
  const isValid: boolean =
    !!searchValues.toCity &&
    !!searchValues.fromCity &&
    !!searchValues.flyoutDate
    ...
    <div className="w-full h-full max-w-screen-xl mx-auto">
      ...
      <div className="mx-auto bg-gray-200 rounded-xl drop-shadow-3xl">
        <div className="bg-blue-500 p-4 w-full flex flex-wrap justify-center gap-3 rounded-t-xl text-black">
          ...
          <div>
            <DatePicker
              dateInit={searchValues.flyoutDate}
              label="Туда"
              getDate={onDatePickHandler}
              upToDate={searchValues.arrivalDate}
            />
          </div>
          <div>
            <DatePicker
              dateInit={searchValues.arrivalDate}
              label="Обратно"
              getDate={onDatePickHandler}
              fromDate={searchValues.flyoutDate}
            />
          </div>
        </div>
